...
function mfwp_options_page() {
  ...
  ob_start(); ?>
  <div class="wrap">
    <h2>Follow Me on Twitter Options</h2>
    <form method="post" action="options.php">
      <?php settings_fields('mfwp_settings_group'); ?>
        ...
        <p>
            ...
            <label class="description" for="mfwp_settings[enable]"><?php _e('Display the Follow Me on Twitter', 'mfwp_domain'); ?></label>
        </p>
...
function mfwp_add_options_link() {
  add_options_page('Follow Me on Twitter Options', 'Follow Me', 'manage_options', 'mfwp-options', 'mfwp_options_page');
}
